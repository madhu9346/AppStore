...
class AppStore extends Component {
  ...
  filterTabItem = () => {
    ...
    const filterResultList = appsList.filter(
  ...
  render() {
    ...
    const filterResultList = this.filterTabItem()
    const searchList = filterResultList.filter(each =>
      each.appName.toLowerCase().includes(searchValue.toLowerCase()),
    )
    return (
      <div className="main-con">
        <h1 className="main-head">App Store</h1>
